...
cdef class Former:
    ...
    def initialize(self, data, fname='data.json'):
        ...
        cdef Ccvp.aircraftpce_cvp_prb *cprb = ccvp.prb
        cdef Ccvp.aircraftpce_term *H = cprb.H
        cdef Ccvp.aircraftpce_term *g = cprb.g
        cdef Ccvp.aircraftpce_term *u_lb = cprb.u_lb
        cdef Ccvp.aircraftpce_term *u_ub = cprb.u_ub
        self.prb = Prb(
    ...
    def form_problem(self, pardata):
        ...
        Ccvp.aircraftpce_cvp_form_problem(ccvp)
